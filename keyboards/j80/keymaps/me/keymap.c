...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_WKL_wrapper(
      KC_ESC,  _________________QWERTY_L0_________________, _________________QWERTY_R0_________________, KC_F11,     KC_F12,                  KC_PSCR, KC_SLCK, KC_PAUS,
      ...
      KC_LSFT, _________________QWERTY_L4_________________, _________________QWERTY_R4_________________,             KC_RSFT,    MO(_FN),              KC_UP,
      KC_LCTL,          KC_LALT,                     SPCFN,                                              KC_RGUI,                MO(_FN),     KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FN] = LAYOUT_WKL_wrapper(
      _______, ____________________FN_L0__________________, ____________________FN_R0__________________, _______, _______,                    _______, _______, _______,
      _______, ____________________FN_L1__________________, ____________________FN_R1__________________, _______, _______, TG(_GAMING),       KC_MPRV, KC_MNXT, KC_VOLU,
      ...
      _______, ____________________FN_L4__________________, ____________________FN_R4__________________,          _______, _______,                    _______,
    ...
    [_SPACEFN] = LAYOUT_WKL_wrapper(
      ...
      _______, _________________SPACEFN_L4________________, _________________SPACEFN_R4________________,          _______, _______,                    _______,
      _______,          _______,                   _______,                                              _______,          _______,           _______, _______, _______
    ),
    [_GAMING] = LAYOUT_WKL_wrapper(
      ...
      _______, _________________GAMING_L4_________________, _________________GAMING_R4_________________,          _______, _______,                    _______,
